...
public class NominaController implements Initializable {
    ...
    @FXML
    private TextField txtMatricula, txtNombre, txtApellidos, txtHorasTrabajadas, txtBuscar;
    ...
    protected void onAgregarEmpleadoButtonClick() {
        ...
        //llama para limpiar el formulario
        limpiarFormulario();
    }
    
    /**
     * Limpia el formulario de captura de datos
     */
    @FXML
    ...
    /**
     * Permite buscar un empleado por matrícula o por
     * nombre
     */
    @FXML
